...
int main() {
    std::cout << "-- Início dos Testes da Lista Encadeada --" << std::endl;
    ...
    std::cout << "A lista está vazia? " << (lista.estaVazia() ? "Sim" : "Não") << std::endl;
    ...
    std::cout << "Tamanho atual da lista: " << lista.obterTamanho() << std::endl;
    std::cout << "A lista está vazia? " << (lista.estaVazia() ? "Sim" : "Não") << std::endl;
